...
func testIntegerObject(t *testing.T, obj object.Object, expected int64) bool {
	...
	if !ok {
		t.Errorf("object is not Integer. obj object.Object, expected int64")
		return false
	}
...
func TestStringConcatenation(t *testing.T) {
	...
	str, ok := evaluated.(*object.String)
	if !ok {
		t.Fatalf("object is not String. get=%T (%+v)", evaluated, evaluated)
	}

	if str.Value != "Hello World!" {
		t.Errorf("String has wrong value. get=%q", str.Value)
	}
}
